...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Nouvelle archive | Hive</title>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              ...
              <li>
                <a href="new_archive.php" class="active"> Créer une archive</a>
              </li>
              <!-- <?php
                if (is_superAdmin()) {
                  echo("
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="card-style mb-30">
                      ...
                      ?>
                      <input type="hidden" name="action" value="newArchive">

                      <div class="input-style-1">
                        <label>Détails sur l'archive</label>
                        <input type="text" name="titredocument"  placeholder="Titre du document" required/>
                      </div>
                      ...
                      <div class="input-style-2">
                          <label class="col-lg-3 col-form-label form-control-label">charger un fichier ( 100Mo max)</label>
                          <div class="col-lg-12">
                            <input class="form-control" name="docfichier" type="file" id="file-input" required>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-style mb-30">
                    <div class="input-style-1">
                      ...
                      <textarea name="commentaire" placeholder="Commentaires" rows="5" required></textarea>
                    </div>
                  </div>
                  <!-- ======= textarea style end ======= -->
                </div>
                ...
                <div class="row">
                  <div class= "col-md-12 text-end"> 
                    <input type="submit" class=" btn btn-primary  m-auto" name="submit" value="Enregistrer"/>
                  </div>
                </div>
              </div>
            </form>
